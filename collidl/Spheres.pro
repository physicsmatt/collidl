...
pro main,data
	...
	for i=0,n_elements(fs)-1 do begin
		...
		print, 'Found ', n_elements(w), ' spheres...'
		...
		print_img=fltarr(3,1000,1000)
		print_img[0,*,*]=img[*,*,0]
		print_img[1,*,*]=img[*,*,1]
		print_img[2,*,*]=img[*,*,2]
		write_tiff, '/home/angelscu/101801/superimpose.tif', print_img
